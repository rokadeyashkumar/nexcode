...
export default function Login({ onBackToHome, onLogin, onSwitchToSignup, onGoogleLogin }) {
      ...
      <div className={styles.authLeft}>
        ...
        <div className={styles.brandMiddle}>
          ...
          <p className={styles.brandSub}>
            Real-time collaborative code editing with region-level review.
            No more waiting on pull requests.
          </p>
        ...
        <div className={styles.brandBottom}>
          <span>Trusted by development teams</span>
        </div>
      </div>
